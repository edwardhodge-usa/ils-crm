...
const CONTACT_MAPPINGS: FieldMapping[] = [
  ...
  { local: 'event_tags', airtable: CONTACTS.eventTags, type: 'multiSelect' },
  ...
  { local: 'categorization', airtable: CONTACTS.categorization, type: 'multiSelect' },
...
const IMPORTED_CONTACT_MAPPINGS: FieldMapping[] = [
  ...
  { local: 'categorization', airtable: IMPORTED_CONTACTS.categorization, type: 'multiSelect' },
