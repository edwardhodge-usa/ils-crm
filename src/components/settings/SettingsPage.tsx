...
import { PipelineMode } from '../dashboard/PipelineWidget'
...
function SectionHeader({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[10px] font-bold uppercase tracking-[0.07em] text-[var(--text-label)] mb-3">
      {children}
    </p>
  )
}
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      <div className="w-[180px] flex-shrink-0 bg-[var(--bg-sidebar)] border-r border-[var(--separator)] flex flex-col py-4 overflow-hidden">
        <p className="px-4 pb-3 text-[10px] font-bold uppercase tracking-[0.07em] text-[var(--text-label)] select-none">
          Settings
        </p>
