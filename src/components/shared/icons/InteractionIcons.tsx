...
export function interactionTypeIcon(type: string | null | undefined, size = 14): ReactNode {
  const props = { width: size, height: size, viewBox: '0 0 24 24', ...defaultProps }
  ...
  if (t.includes('meeting') || t.includes('lunch') || t.includes('dinner') || t.includes('conference'))
